...
POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_backend_to_string)
{
...
POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_convmode_to_string)
{
    testEnumToString("Default", ::AF_CONV_DEFAULT);
    testEnumToString("Expand",  ::AF_CONV_EXPAND);
}

POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_convdomain_to_string)
{
...
POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_randomenginetype_to_string)
{
...
POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_topkfunction_to_string)
{
...
POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_dtype_to_string)
{
...
POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_array_to_string)
{
...
POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_array_compare)
{
...
POTHOS_TEST_BLOCK("/arrayfire/tests", test_af_array_serialization)
{
