...
#define SPECIALIZE_TEMPLATE_TEST_WITH_REDUCEDINT8OUT(T) \
    ...
    template \
    void testReducedBlock<T, char>(const std::string&, size_t);

SPECIALIZE_TEMPLATE_TEST(char)
SPECIALIZE_TEMPLATE_TEST(signed char)
SPECIALIZE_TEMPLATE_TEST_WITH_REDUCEDINT8OUT(short)
SPECIALIZE_TEMPLATE_TEST_WITH_REDUCEDINT8OUT(int)
SPECIALIZE_TEMPLATE_TEST_WITH_REDUCEDINT8OUT(long long)
SPECIALIZE_TEMPLATE_TEST_WITH_REDUCEDINT8OUT(unsigned char)
SPECIALIZE_TEMPLATE_TEST_WITH_REDUCEDINT8OUT(unsigned short)
SPECIALIZE_TEMPLATE_TEST_WITH_REDUCEDINT8OUT(unsigned)
SPECIALIZE_TEMPLATE_TEST_WITH_REDUCEDINT8OUT(unsigned long long)
